                ...
                <div class="fixed flex flex-col top-14 left-0 w-14 hover:w-64 md:w-64 bg-orange-100 dark:bg-gray-900 h-full  text-gray-800 transition-all duration-300 border-none z-10 sidebar">
                  <div class="overflow-y-auto overflow-x-hidden flex flex-col justify-between flex-grow">
                    <ul class="flex flex-col py-4 space-y-1">
                      <li>
                        <a href="{{ route('dashboard.index') }}" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-orange-200 dark:hover:bg-gray-600 dark:text-white text-gray-800 hover:text-gray-500 border-l-4 border-transparent hover:border-blue-500 dark:hover:border-gray-800 pr-6">
                      ...
                      <li>
                        <a href="{{ route('schedules.index') }}" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-orange-200 dark:hover:bg-gray-600 dark:text-white text-gray-800 hover:text-gray-500 border-l-4 border-transparent hover:border-blue-500 dark:hover:border-gray-800 pr-6">
                          <span class="inline-flex justify-center items-center ml-4">
