...
#navbar {
  ...
  /* Additional styling to ensure the content is visible below the navbar */
  .content {
    padding-top: 60px; /* Adjust to match the total height of the navbar */
  }
...
<div id="navbar">
  <div class="slide-menu">
    ...
    <ul style="display: flex; align-items: center; margin: 0; padding: 0; margin-right:30px;">
      ...
      <li>
        <a href="{{ route('logout') }}" class="hover:text-blue-100 dark:text-white text-gray-800 cursor-pointer hover:text-gray-600" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
          {{ __('Logout') }}
        </a>
      </li>
