...
<link rel="apple-touch-icon" sizes="180x180" href="{{ asset('storage/public/img/apple-touch-icon.png') }}">
<link rel="icon" type="image/png" sizes="32x32" href="{{ asset('storage/public/img/favicon-16x16.png') }}">
<link rel="icon" type="image/png" sizes="16x16" href="{{ asset('storage/public/img/favicon-52x52.png') }}">
...
.footer{
width:100%;
background-image:url("{{ asset('storage/img/photos/background-footer.png') }}");
background-size:100% 100%;
padding:20px 0px;
}
